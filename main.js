...
function cycleGame() {
  ...
  if (numOfAnswers) {
    //  если есть вопросы
    if (time != -1)
      //  и если не закончилось время
      timer = setTimeout("cycleGame()", 1000);
    //  то крутить цикл
    else {
...
function seeTheQuest(k) {
  // функция с заданиями
  switch (k) {
    case 5:
      $("#b").html(
        '<a href="#" id="success" class="b">черный</a><br /><a href="#" class="b">синий</a><br /><a href="#" class="b">красный</a>'
      );
      break;
    case 4:
      $("#b").html(
        '<a href="#" class="g">черный</a><br /><a href="#" id="success" class="bl">синий</a><br /><a href="#" class="b">зеленый</a>'
      );
      break;
    case 3:
      $("#b").html(
        '<a href="#" class="g">красный</a><br /><a href="#" class="b">синий</a><br /><a href="#" id="success" class="g">зеленый</a>'
      );
      break;
    case 2:
      $("#b").html(
        '<a href="#" id="success" class="bl">синий</a><br /><a href="#" class="b">красный</a><br /><a href="#" class="bl">зеленый</a>'
      );
      break;
    case 1:
      $("#b").html(
        '<a href="#" class="b">синий</a><br /><a href="#" id="success" class="r">красный</a><br /><a href="#" class="bl">черный</a>'
      );
      break;
    default:
      //  закончились вопросы
...
function resume() {
  ...
  $("#b").html(
    "<p>Вы набрали " +
      numOfSuccess +
      ' очков из 5</p><a href="#">Играть снова</a>'
  );
  run();
}
