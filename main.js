var timer,              //  игровой таймер
	...
	function seeTheQuest(k)     // функция с заданиями
		{
			...
			{
				case 5:
					$('#b').html('<a href="javascript:success()" class="b">черный</a><br /><a href="#" class="b">синий</a><br /><a href="#" class="b">красный</a>');
					break;
				case 4:
					$('#b').html('<a href="#" class="g">черный</a><br /><a href="javascript:success()" class="bl">синий</a><br /><a href="#" class="b">зеленый</a>');
					break;
				case 3:
					$('#b').html('<a href="#" class="g">красный</a><br /><a href="#" class="b">синий</a><br /><a href="javascript:success()" class="g">зеленый</a>');
					break;
				case 2:
					$('#b').html('<a href="javascript:success()" class="bl">синий</a><br /><a href="#" class="b">красный</a><br /><a href="#" class="bl">зеленый</a>');
					break;
				case 1:
					$('#b').html('<a href="" class="b">синий</a><br /><a href="javascript:success()" class="r">красный</a><br /><a href="#" class="bl">черный</a>');
					break;
	...
	function resume()   //  функция вывода результатов
		{
			$('#b').html('<p>Вы набрали ' + numOfSuccess + ' очков из 5</p><a href="javascript:Main()">Играть снова</a>');
		}
